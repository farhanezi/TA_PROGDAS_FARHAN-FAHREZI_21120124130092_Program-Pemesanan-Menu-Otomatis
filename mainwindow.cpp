...
void MainWindow::hal3tohal4(){ //sekkkkkkkkkkkkkkkk
    QList<Menu> menuList = {
...
void MainWindow::naikramen1()
{
    ...
    ui->labelramen1->setText(QString::number(valueramen1)); // Update label
}
...
void MainWindow::naikramen2()
{
    ...
    ui->labelramen2->setText(QString::number(valueramen2)); // Update label
}
...
void MainWindow::naikramen3()
{
    ...
    ui->labelramen3->setText(QString::number(valueramen3)); // Update label
}
...
void MainWindow::naiksushi1()
{
    ...
    ui->labelsushi1->setText(QString::number(valuesushi1)); // Update label
}
...
void MainWindow::naiksushi2()
{
    ...
    ui->labelsushi2->setText(QString::number(valuesushi2)); // Update label
}
...
void MainWindow::naiksushi3()
{
    ...
    ui->labelsushi3->setText(QString::number(valuesushi3)); // Update label
}
